...
import com.messaging.chatrapid.databinding.ActivitySignInBinding;
import com.messaging.chatrapid.databinding.ActivitySignUpBinding;

public class SignInActivity extends AppCompatActivity {

    ActivitySignInBinding binding;
    ProgressDialog Login,googleSignin;
    FirebaseAuth auth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Login = new ProgressDialog(SignInActivity.this);
        Login.setTitle("Login");
        Login.setMessage("Login to your Account");

        googleSignin = new ProgressDialog(SignInActivity.this);
        ...
        binding.btnSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Login.show();
                auth.signInWithEmailAndPassword(binding.emailId.getText().toString(), binding.passwordId.getText().toString()).
